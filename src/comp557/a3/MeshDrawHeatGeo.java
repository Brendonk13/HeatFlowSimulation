...
public class MeshDrawHeatGeo {
    ...
    private int uPowerID;
    private int umaximumPhi;
	...
	public static void setMaxPhiUniform(double maximumPhi) {
		maxPhi = (float) maximumPhi;
	}
	...
	public void init( GL2 gl ) {
        ...
        uPowerID = state.getUniformLocation(gl, "power");
        umaximumPhi = state.getUniformLocation(gl, "maxPhi");
    ...
    public void drawVBOs( GL2 gl ) {
        ...
        // final int shiny = shininess.getValue();
		...
		gl.glUniform1f(uPowerID,  power.getValue().floatValue());
		gl.glUniform1f(umaximumPhi,  maxPhi);
